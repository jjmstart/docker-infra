...
| [v1.7-alerting-pipeline-spof-audit.md](v1.7-alerting-pipeline-spof-audit.md) | V1.7 | 告警链路 SPOF 盲点：watchdog 自己也是把告警发给 bj-01 同一份 Alertmanager；按 4 个独立失效域审视后，DMS 独立成 v1.8 覆盖 #2/#3/#4，watchdog 保留在顺延后的 v1.14 仅覆盖 #1 | 已识别 + 已规划修复 |
