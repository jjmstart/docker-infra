...
| [narratives/v1.7.md](narratives/v1.7.md)     | V1.7 | 7     | IaC 完整性 / CI 质量门禁 / 网关耦合演进时机 / 入口探测功能深度盲区 / Jenkins 403 双层语义 / Prometheus reload inode 陷阱 / Jenkins CD 路径过滤层级试错（含一句话版、Q&A、工程原则） |
