...
| [v1.2-to-v1.3.md](v1.2-to-v1.3.md) | `/opt/docker` 纳入 Git 版本控制，推送至 GitHub Private 仓库，建立 .env.example 模板，四节点 clone 同一仓库 | gz-03（Git 初始化 + 推送）、gz-01 / gz-02 / bj-01（clone） |
